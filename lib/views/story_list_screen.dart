              ...
              itemBuilder: (context, inx) {
                return FutureBuilder(
                  ...
                  builder: (context, AsyncSnapshot<dynamic> storySnap) {
                    ...
                    final listTileTitle = story?.title ?? "Error Fetching Title";
                    ...
                    return ListTile(
                      ...
                      subtitle: Text("Posted On: $dateString\n" + "\nBy: ${story.by}" ),
                      // Disabling the fav button if the story is not appropriate.
                      trailing: FavoriteButton(story: story, isFav: false, disabled: listTileTitle=="Story Unavailable",),   
                    );
                  },
                );
              },
